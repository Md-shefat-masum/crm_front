...
function Edit() {
  ...
  }, [fetch_all_contact_number, fetch_all_customer, get_users, id, set_data]);
  ...
  if (data_store.singleData) {
    const { date, contact_type, note } = data_store.singleData;
    return (
                ...
                <div className="col-lg-8">
                  <div className="form-group mb-5">
                    ...
                    <div className="custom_form_el">
                      ...
                      <div>:</div>
                      <div><input name="date" type="date" className="form-control" defaultValue={moment(date).format('YYYY-MM-DD')} /></div>
                    </div>
                    <div className="custom_form_el">
