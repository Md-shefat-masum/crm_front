    ...
    <div className="card list_card">
      <div className="card-header ">
        ...
        <div className="btns d-flex gap-2 align-items-center">
          <a href="#/dashboard/contact-number" className="btn rounded-pill btn-outline-secondary">
              ...
              <div className="col-lg-8">
                <div className="form-group mb-5">
                  ...
                  <div className="custom_form_el">
                    ...
                    <div>:</div>
                    <div><input name="operator" type="text" className="form-control" defaultValue={operator} /></div>
                  </div>
                  <div className="custom_form_el">
                    <label htmlFor="">Details</label>
                    <div>:</div>
                    <div><input name="details" type="text" className="form-control" defaultValue={details} /></div>
                  </div> 
                </div>
              </div>
            </div>
